...
class InputFilter {
	...
	function decode($source) {
		...
		// convert decimal
		$source = preg_replace_callback('/&#(\d+);/m',function(){return "chr(\\1)";}, $source);				// decimal notation
		// convert hex
		$source = preg_replace_callback('/&#x([a-f0-9]+);/mi',function(){return "chr(0x\\1)";}, $source);	// hex notation
		return $source;
	}
